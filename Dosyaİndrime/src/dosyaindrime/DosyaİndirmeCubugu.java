 ...
 * @author pc
 */
public class DosyaİndirmeCubugu extends javax.swing.JFrame {
    
    private int say=0;
    /**
     * Creates new form DosyaİndirmeCubugu
     */
    public DosyaİndirmeCubugu() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(119, 119, 119)
                .addComponent(checkProgress, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(dosyaindir)
        ...
        timer.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (checkProgress.getValue()==100) {
                    JOptionPane.showMessageDialog(DosyaİndirmeCubugu.this,"Dosya indirme tamamlandı" );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DosyaİndirmeCubugu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DosyaİndirmeCubugu().setVisible(true);
            }
        });
    }
